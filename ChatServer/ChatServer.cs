...
namespace ChatServer
{
    class ChatServer
    {
        ...
        // The event and its argument will notify the form when a user has connected, disconnected, sent a message, etc.
        ...
        public static void SendMessage(string From, string Message)
        {
            ...
            // First ofall, show in our application who says what
